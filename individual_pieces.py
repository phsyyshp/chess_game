...
class queen:
    def __init__(self, position_row_column, color):
        ...
        self.type = 'queen'
    def moves_in_range(self):
        return horizontal_squares(self.position_row_column) + vertical_squares(self.position_row_column) +  diagonal_squares(self.position_row_column)
class king:
    def __init__(self, position_row_column, color):
        self.position_row_column = position_row_column
        self.color = color
        self.type = 'king'
    def moves_in_range(self):
        return horizontal_squares(self.position_row_column, amount= 1) + vertical_squares(self.position_row_column, amount= 1) +  diagonal_squares(self.position_row_column, amount= 1)
pp = pawn('a7','white')